...
epochs = 10
averageOver = 10
expDescr = "Bengio 3n4 - no freeze = {} - average over {} runs".format(str(freeze), averageOver)
...
epochs = 10
averageOver = 10
expDescr = "Bengio 4n4 - no freeze = {} - average over {} runs".format(str(freeze), averageOver)
