...
# Experiment description
expDescr = "Expansion learning, random network guessing D_4"
...
weightsSource = '107'
model, nnStr = createModel()
scoreRND = calcScoreBigData(model)
